...
export function Hero5(){
    ...
    return(
      ...
      <div className="relative w-[90%] lg:w-[80%] grid gap-10 border border-[#3A506B] rounded-[10px] p-[4%] bg-[#011210]">
        ...
        <div className="flex flex-col lg:flex-row justify-between z-10">
          ...
          <div className="flex flex-col justify-between items-start lg:items-end font-[700] text-[15px] lg:text-[20px] mt-5 lg:mt-0">
            ...
            <input className="bg-[#011210] font-medium text-[#909090] px-3 py-1 rounded-[10px] border border-[#3A506B] focus:outline-none overflow-hidden"
              ...
              ref={inputRef}
            />
            <button className="bg-[#5BC0BE] w-[80px] lg:w-[130px] flex flex-row h-[35px] lg:h-[40px] border border-[#3A506B] shadow-sm shadow-[#67E6D8] justify-center items-center rounded-[5px] mt-2 lg:mt-4">
